...
const Elements = ({ text, imageSrc }: ElementsProps) => (
  <div className="relative">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <p className="text-black text-lg font-Short_Stack uppercase pl-12 pr-14">
                {text}
              </p>
            </div>
          </div>
...
export default function Home() {
  return (
    <>
      <div className="flex flex-col w-[85%] mx-auto gap-3">
        <div className="bg-rose-400 rounded-3xl border-rose-300 border-dashed border-[3px] max-w-[529px] min-h-[50px] shadow-[0px_0px_11px_rgba(0,0,0,0.25)] mx-auto">
          <h1 className="text-white font-Short_Stack text-[32px] flex items-center justify-center pl-5 pr-5">
            Elements of Story Writing
          </h1>
        </div>
        <h1 className="text-black font-Short_Stack text-[24px] flex items-center justify-start mt-3 mb-3 leading-[29px] tracking-[-6%]">
        ...
        <div className="bg-teal-500 rounded-md border-cyan-200 border-dashed shadow-sm border-[3px] min-h-[114px]">
          <div className="flex flex-row justify-between items-center gap-3">
            <h1 className="text-white font-Short_Stack text-[24px] px-4 ">
        ...
        <h1 className="text-black font-Short_Stack text-[24px] flex items-center justify-start mt-3 mb-3">
        ...
        <div className="flex flex-col px-5 pb-2 bg-rose-400 rounded-3xl shadow-lg shadow-slate-500 relative">
          <div className="relative">
            ...
            <div className="absolute inset-0 flex ">
              <p className="text-black text-[24px] font-Short_Stack uppercase w-[96%] pl-10 pt-3">
